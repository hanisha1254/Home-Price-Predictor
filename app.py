...
with open(
        r"C:\Users\Hanisha\Desktop\Data_Science__Machine_Learning-Projects-main\Project 1\bangalore_home_prices_model.pickle",
        'rb') as f:
    __model = pickle.load(f)

with open(r"C:\Users\Hanisha\Desktop\Data_Science__Machine_Learning-Projects-main\Project 1\Columns.json", 'r') as obj:
